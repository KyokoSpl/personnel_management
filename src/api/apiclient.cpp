...
void ApiClient::createSalaryGrade(const QString& code, double baseSalary,
...
void ApiClient::updateSalaryGrade(const QString& id, const QString& code, double baseSalary,
                                  const QString& description) {
    QJsonObject data;
    if (!code.isEmpty())
        data["code"] = code;
